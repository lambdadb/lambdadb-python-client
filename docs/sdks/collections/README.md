...
| `index_configs`                                                                         | Dict[str, [models.IndexConfigsUnion](../../models/indexconfigsunion.md)]                | :heavy_check_mark:                                                                      | Nonempty collection index configuration.                                               |
...
| `tags`                                                                                  | *Optional[Dict[str, str]]*                                                              | :heavy_minus_sign:                                                                      | Up to five metadata tags; values must contain a non-whitespace character.              |
